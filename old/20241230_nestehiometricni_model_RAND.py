...
with pd.ExcelWriter(str_excel, engine='openpyxl', mode='a',if_sheet_exists='overlay') as writer:
    df_results.to_excel(writer, sheet_name=str_sheet, index=False, header =False, startrow=21, startcol=0)
    '''
    ...
    condensedphases = CondensedPhases("biomass H2O(l)") # defines condensed species in the system
    ...
    result = [MC*100, w_C*100, w_H*100, w_O*100, w_N*100, 
              ...
              temp, phi_CO*100, phi_H2*100, phi_CH4*100, phi_CO2*100, phi_H2O*100, phi_N2*100, n_C, M_g, LHV_g_V/1000, LHV_g_m, CGE, CGE_tot, GY, succeeded,
